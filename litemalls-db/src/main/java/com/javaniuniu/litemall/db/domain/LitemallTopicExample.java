...
public class LitemallTopicExample {
    ...
    protected abstract static class GeneratedCriteria {
        ...
        protected void addGoodsCriterion(String condition, Object value, String property) {
            ...
            goodsCriteria.add(new Criterion(condition, value, "com.javaniuniu.litemall.db.mybatis.JsonIntegerArrayTypeHandler"));
            allCriteria = null;
        }
        ...
        protected void addGoodsCriterion(String condition, Integer[] value1, Integer[] value2, String property) {
            ...
            goodsCriteria.add(new Criterion(condition, value1, value2, "com.javaniuniu.litemall.db.mybatis.JsonIntegerArrayTypeHandler"));
            allCriteria = null;
        }
    ...
    public interface IExampleWhen {
         ...
         * @mbg.generated
         */
        void example(com.javaniuniu.litemall.db.domain.LitemallTopicExample example);
    }
}
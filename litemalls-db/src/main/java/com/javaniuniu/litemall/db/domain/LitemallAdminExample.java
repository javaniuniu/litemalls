...
public class LitemallAdminExample {
    ...
    protected abstract static class GeneratedCriteria {
        ...
        protected void addRoleIdsCriterion(String condition, Object value, String property) {
            ...
            roleIdsCriteria.add(new Criterion(condition, value, "com.javaniuniu.litemall.db.mybatis.JsonIntegerArrayTypeHandler"));
            allCriteria = null;
        }
        ...
        protected void addRoleIdsCriterion(String condition, Integer[] value1, Integer[] value2, String property) {
            ...
            roleIdsCriteria.add(new Criterion(condition, value1, value2, "com.javaniuniu.litemall.db.mybatis.JsonIntegerArrayTypeHandler"));
            allCriteria = null;
        }
    ...
    public interface IExampleWhen {
         ...
         * @mbg.generated
         */
        void example(com.javaniuniu.litemall.db.domain.LitemallAdminExample example);
    }
}